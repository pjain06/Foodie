...
<div class="tabs"  style="padding:10px; margin-left: 0px; height:1000px; width: 13%; background-color: #f8f8f8">
	...
	<div class="links" style="width:100%; height: 80px; background-color:#A52A2A; margin-top: -5px; border-radius:5px">
...
<div class="row" id="test" style="padding-bottom:10px; margin-left: 200px; width: 100%; background-color: #f8f8f8; margin-top: -1000px">


<div class="col-sm-offset-1 col-sm-4">
<h3 class="page-header">Upcoming Events in your registered groups</h3>
<?php include_once("DBconnect.php");

$sql = "select eid,gid,eventName, eDescription, locationCity,startTime,endTime, gname from event natural join group_members natural join cooking_group where  startTime>now() and uid='$uid'";
